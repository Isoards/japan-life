...
Cooking Pantry 가져오기는 수량·가격·유통기한 추정, 바코드, 이미지 보관, 새 Ingredient 자동 생성을 지원하지 않습니다. Expenses 가져오기는 품목 행 끝의 가격과 영수증 합계를 추출하지만 할인·세금·별도 가격 행을 완벽하게 복원하지는 않습니다. 흐리거나 구겨진 사진, 손글씨, 마트 고유의 지나친 축약 표기는 두 화면 모두 사용자 검토가 필요할 수 있습니다.
