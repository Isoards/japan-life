    ...
    <div className="space-y-6">
      ...
      {showForm && (
        <div className="rounded-xl border border-white/10 bg-white/5 p-5 space-y-3">
          <h3 className="text-sm font-medium text-white">새 장소 기록</h3>
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => { setShowForm(false); setFormLat(null); setFormLng(null); }} className="px-4 py-2 rounded-lg text-sm text-gray-400 hover:text-white hover:bg-white/5 transition-colors">취소</button>
          </div>
        </div>
      )}
