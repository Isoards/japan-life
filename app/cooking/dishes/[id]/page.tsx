...
import { COLLECTION_SECTION_LABELS, CUISINE_LABELS, IMPORTANCE_LABELS, displayDishName } from "@/lib/cooking/names";
...
export default async function DishDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="space-y-7">
    <CookingHeader title={displayDishName(dish)} description={`${dish.collection === "RYU_SO_YOUNG" ? `류수영 · ${COLLECTION_SECTION_LABELS[dish.collectionSection!]}` : CUISINE_LABELS[dish.cuisine]} · 난이도 ${dish.difficulty === "EASY" ? "쉬움" : dish.difficulty === "MEDIUM" ? "보통" : "어려움"}`} />
